...
rpc_client:
	g++ -std=c++11 -pthread -lpthread ./src/minico/*.cpp ./src/tcp/*.cpp ./src/rpc/*.cpp ./src/test_client.cpp -o rpc_client

rpc_server:
	g++ -std=c++11 -pthread -lpthread ./src/minico/*.cpp ./src/tcp/*.cpp ./src/rpc/*.cpp ./src/test_server.cpp -o rpc_server
